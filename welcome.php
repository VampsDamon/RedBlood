...
/* ABOUT ENDS */
  ...
  <body>
    <div class="container">
      <nav class="flex">
        <a href="welcome.php"><img id="logoimg" src="Images/Img/Illustrated Blood Donor Hospital Logo.png" alt="logo"></a>
    ...
    <div class="text-box">
       <h1>Welcome </h1>
      <h1>Saving Lives </h1>
      <p>We Welcome You <?php echo $_SESSION['username']?> <br><br>Become a donor or request for blood And help save lives</p>';
      <a href="logout.php" class="hero-btn" target="_blank">Log-Out</a>
